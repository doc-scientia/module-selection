...
class ExamTimetableGroup(BaseProvider):
    def exam_timetable_constraint(self) -> str:
        return random.choice(ExamTimetableConstraint.members())  # nosec
...
factory.Faker.add_provider(ExamTimetableGroup)
